...
func init() {
	proto.RegisterType((*ExportTraceServiceRequest)(nil), "otlp_7.ExportTraceServiceRequest")
	proto.RegisterType((*ExportTraceServiceResponse)(nil), "otlp_7.ExportTraceServiceResponse")
}
...
var fileDescriptor_5f1ed3a7bae0d0a6 = []byte{
	...
	0x62, 0xcb, 0x2f, 0xc9, 0x29, 0x88, 0x37, 0x97, 0xe2, 0x06, 0x4b, 0x42, 0x04, 0x95, 0x22, 0xb9,
	...
	0xff, 0xff, 0xc3, 0xdc, 0x87, 0x2d, 0x3d, 0x01, 0x00, 0x00,
}
...
func (c *traceServiceClient) Export(ctx context.Context, in *ExportTraceServiceRequest, opts ...grpc.CallOption) (*ExportTraceServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_7.TraceService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TraceService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_7.TraceService/Export",
	}
...
var _TraceService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_7.TraceService",
