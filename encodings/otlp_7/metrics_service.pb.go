...
func init() {
	proto.RegisterType((*ExportMetricsServiceRequest)(nil), "otlp_7.ExportMetricsServiceRequest")
	proto.RegisterType((*ExportMetricsServiceResponse)(nil), "otlp_7.ExportMetricsServiceResponse")
}
...
var fileDescriptor_3539b795f43dad34 = []byte{
	...
	0xc9, 0x17, 0x62, 0xcb, 0x2f, 0xc9, 0x29, 0x88, 0x37, 0x97, 0xe2, 0x85, 0x4a, 0x43, 0x84, 0x95,
	...
	0x00, 0xff, 0xff, 0xbe, 0xa3, 0x48, 0x52, 0x53, 0x01, 0x00, 0x00,
}
...
func (c *metricsServiceClient) Export(ctx context.Context, in *ExportMetricsServiceRequest, opts ...grpc.CallOption) (*ExportMetricsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_7.MetricsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetricsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_7.MetricsService/Export",
	}
...
var _MetricsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_7.MetricsService",
