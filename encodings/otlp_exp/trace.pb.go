...
type Span struct {
	...
	Kind Span_SpanKind `protobuf:"varint,6,opt,name=kind,proto3,enum=otlp_exp.Span_SpanKind" json:"kind,omitempty"`
...
type Status struct {
	...
	DeprecatedCode Status_DeprecatedStatusCode `protobuf:"varint,1,opt,name=deprecated_code,json=deprecatedCode,proto3,enum=otlp_exp.Status_DeprecatedStatusCode" json:"deprecated_code,omitempty"` // Deprecated: Do not use.
	// A developer-facing human readable error message.
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	// The status code.
	Code Status_StatusCode `protobuf:"varint,3,opt,name=code,proto3,enum=otlp_exp.Status_StatusCode" json:"code,omitempty"`
}
...
func init() {
	proto.RegisterEnum("otlp_exp.Span_SpanKind", Span_SpanKind_name, Span_SpanKind_value)
	proto.RegisterEnum("otlp_exp.Status_DeprecatedStatusCode", Status_DeprecatedStatusCode_name, Status_DeprecatedStatusCode_value)
	proto.RegisterEnum("otlp_exp.Status_StatusCode", Status_StatusCode_name, Status_StatusCode_value)
	proto.RegisterType((*ResourceSpans)(nil), "otlp_exp.ResourceSpans")
	proto.RegisterType((*InstrumentationLibrarySpans)(nil), "otlp_exp.InstrumentationLibrarySpans")
	proto.RegisterType((*Span)(nil), "otlp_exp.Span")
	proto.RegisterType((*Span_Event)(nil), "otlp_exp.Span.Event")
	proto.RegisterType((*Span_Link)(nil), "otlp_exp.Span.Link")
	proto.RegisterType((*Status)(nil), "otlp_exp.Status")
}
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
