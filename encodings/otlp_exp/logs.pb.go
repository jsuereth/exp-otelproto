...
type LogRecord struct {
	...
	// [Optional].
	SeverityNumber SeverityNumber `protobuf:"varint,2,opt,name=severity_number,json=severityNumber,proto3,enum=otlp_exp.SeverityNumber" json:"severity_number,omitempty"`
...
func init() {
	proto.RegisterEnum("otlp_exp.SeverityNumber", SeverityNumber_name, SeverityNumber_value)
	proto.RegisterEnum("otlp_exp.LogRecordFlags", LogRecordFlags_name, LogRecordFlags_value)
	proto.RegisterType((*ResourceLogs)(nil), "otlp_exp.ResourceLogs")
	proto.RegisterType((*InstrumentationLibraryLogs)(nil), "otlp_exp.InstrumentationLibraryLogs")
	proto.RegisterType((*LogRecord)(nil), "otlp_exp.LogRecord")
}
...
var fileDescriptor_782e6d65c19305b4 = []byte{
	...
	,
}
