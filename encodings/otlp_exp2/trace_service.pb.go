...
func init() {
	proto.RegisterType((*ExportTraceServiceRequest)(nil), "otlp_exp2.ExportTraceServiceRequest")
	proto.RegisterType((*ExportTraceServiceResponse)(nil), "otlp_exp2.ExportTraceServiceResponse")
}
...
var fileDescriptor_5f1ed3a7bae0d0a6 = []byte{
	...
	,
}
...
func (c *traceServiceClient) Export(ctx context.Context, in *ExportTraceServiceRequest, opts ...grpc.CallOption) (*ExportTraceServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_exp2.TraceService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TraceService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_exp2.TraceService/Export",
	}
...
var _TraceService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_exp2.TraceService",
