...
func init() {
	proto.RegisterType((*ExportMetricsServiceRequest)(nil), "otlp_exp2.ExportMetricsServiceRequest")
	proto.RegisterType((*ExportMetricsServiceResponse)(nil), "otlp_exp2.ExportMetricsServiceResponse")
}
...
var fileDescriptor_3539b795f43dad34 = []byte{
	...
	0xc9, 0x17, 0xe2, 0xcc, 0x2f, 0xc9, 0x29, 0x88, 0x4f, 0xad, 0x28, 0x30, 0x92, 0xe2, 0x85, 0xaa,
	...
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x40, 0x77, 0xdb, 0x0b, 0x5f, 0x01, 0x00, 0x00,
}
...
func (c *metricsServiceClient) Export(ctx context.Context, in *ExportMetricsServiceRequest, opts ...grpc.CallOption) (*ExportMetricsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_exp2.MetricsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetricsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_exp2.MetricsService/Export",
	}
...
var _MetricsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_exp2.MetricsService",
