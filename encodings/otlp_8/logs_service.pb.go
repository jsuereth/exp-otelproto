...
func init() {
	proto.RegisterType((*ExportLogsServiceRequest)(nil), "otlp_8.ExportLogsServiceRequest")
	proto.RegisterType((*ExportLogsServiceResponse)(nil), "otlp_8.ExportLogsServiceResponse")
}
...
var fileDescriptor_7af0811a237bf236 = []byte{
	...
	0xcb, 0x2f, 0xc9, 0x29, 0x88, 0xb7, 0x90, 0xe2, 0x02, 0xc9, 0x41, 0xc4, 0x94, 0x42, 0xb9, 0x24,
	...
	0xa3, 0x55, 0x08, 0x81, 0x32, 0x01, 0x00, 0x00,
}
...
func (c *logsServiceClient) Export(ctx context.Context, in *ExportLogsServiceRequest, opts ...grpc.CallOption) (*ExportLogsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_8.LogsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_8.LogsService/Export",
	}
...
var _LogsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_8.LogsService",
