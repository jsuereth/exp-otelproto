...
func init() {
	proto.RegisterType((*ExportMetricsServiceRequest)(nil), "otlp_8.ExportMetricsServiceRequest")
	proto.RegisterType((*ExportMetricsServiceResponse)(nil), "otlp_8.ExportMetricsServiceResponse")
}
...
var fileDescriptor_3539b795f43dad34 = []byte{
	...
	0xc9, 0x17, 0x62, 0xcb, 0x2f, 0xc9, 0x29, 0x88, 0xb7, 0x90, 0xe2, 0x85, 0x4a, 0x43, 0x84, 0x95,
	...
	0x00, 0xff, 0xff, 0xfb, 0x4f, 0x90, 0xe8, 0x53, 0x01, 0x00, 0x00,
}
...
func (c *metricsServiceClient) Export(ctx context.Context, in *ExportMetricsServiceRequest, opts ...grpc.CallOption) (*ExportMetricsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_8.MetricsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetricsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_8.MetricsService/Export",
	}
...
var _MetricsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_8.MetricsService",
