...
type LogRecord struct {
	...
	// [Optional].
	SeverityNumber SeverityNumber `protobuf:"varint,2,opt,name=severity_number,json=severityNumber,proto3,enum=otlp_6.SeverityNumber" json:"severity_number,omitempty"`
...
func init() {
	proto.RegisterEnum("otlp_6.SeverityNumber", SeverityNumber_name, SeverityNumber_value)
	proto.RegisterEnum("otlp_6.LogRecordFlags", LogRecordFlags_name, LogRecordFlags_value)
	proto.RegisterType((*ResourceLogs)(nil), "otlp_6.ResourceLogs")
	proto.RegisterType((*InstrumentationLibraryLogs)(nil), "otlp_6.InstrumentationLibraryLogs")
	proto.RegisterType((*LogRecord)(nil), "otlp_6.LogRecord")
}
...
var fileDescriptor_782e6d65c19305b4 = []byte{
	...
	0x50, 0x74, 0x15, 0x5d, 0x19, 0x74, 0x75, 0x77, 0x57, 0x86, 0x98, 0x08, 0x85, 0x40, 0x34, 0x40,
	...
	0xe5, 0x9f, 0x01, 0x00, 0x00, 0xff, 0xff, 0x1e, 0xb6, 0x5f, 0x77, 0x4f, 0x06, 0x00, 0x00,
}
