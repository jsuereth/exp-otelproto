...
func init() {
	proto.RegisterType((*ExportLogsServiceRequest)(nil), "otlp_6.ExportLogsServiceRequest")
	proto.RegisterType((*ExportLogsServiceResponse)(nil), "otlp_6.ExportLogsServiceResponse")
}
...
var fileDescriptor_7af0811a237bf236 = []byte{
	...
	0xcb, 0x2f, 0xc9, 0x29, 0x88, 0x37, 0x93, 0xe2, 0x02, 0xc9, 0x41, 0xc4, 0x94, 0x42, 0xb9, 0x24,
	...
	0x5a, 0xde, 0x2e, 0x16, 0x32, 0x01, 0x00, 0x00,
}
...
func (c *logsServiceClient) Export(ctx context.Context, in *ExportLogsServiceRequest, opts ...grpc.CallOption) (*ExportLogsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_6.LogsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_6.LogsService/Export",
	}
...
var _LogsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_6.LogsService",
