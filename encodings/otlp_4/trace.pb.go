...
type Span struct {
	...
	Kind Span_SpanKind `protobuf:"varint,6,opt,name=kind,proto3,enum=otlp_4.Span_SpanKind" json:"kind,omitempty"`
...
type Status struct {
	...
	// when not set.
	Code Status_StatusCode `protobuf:"varint,1,opt,name=code,proto3,enum=otlp_4.Status_StatusCode" json:"code,omitempty"`
...
func init() {
	proto.RegisterEnum("otlp_4.Span_SpanKind", Span_SpanKind_name, Span_SpanKind_value)
	proto.RegisterEnum("otlp_4.Status_StatusCode", Status_StatusCode_name, Status_StatusCode_value)
	proto.RegisterType((*ResourceSpans)(nil), "otlp_4.ResourceSpans")
	proto.RegisterType((*InstrumentationLibrarySpans)(nil), "otlp_4.InstrumentationLibrarySpans")
	proto.RegisterType((*Span)(nil), "otlp_4.Span")
	proto.RegisterType((*Span_Event)(nil), "otlp_4.Span.Event")
	proto.RegisterType((*Span_Link)(nil), "otlp_4.Span.Link")
	proto.RegisterType((*Status)(nil), "otlp_4.Status")
}
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
