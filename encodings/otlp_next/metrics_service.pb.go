...
func init() {
	proto.RegisterType((*ExportMetricsServiceRequest)(nil), "otlp_next.ExportMetricsServiceRequest")
	proto.RegisterType((*ExportMetricsServiceResponse)(nil), "otlp_next.ExportMetricsServiceResponse")
}
...
var fileDescriptor_3539b795f43dad34 = []byte{
	...
	,
}
...
func (c *metricsServiceClient) Export(ctx context.Context, in *ExportMetricsServiceRequest, opts ...grpc.CallOption) (*ExportMetricsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_next.MetricsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetricsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_next.MetricsService/Export",
	}
...
var _MetricsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_next.MetricsService",
