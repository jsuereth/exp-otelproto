...
func init() {
	proto.RegisterType((*ExportTraceServiceRequest)(nil), "otlp_next.ExportTraceServiceRequest")
	proto.RegisterType((*ExportTraceServiceResponse)(nil), "otlp_next.ExportTraceServiceResponse")
}
...
var fileDescriptor_5f1ed3a7bae0d0a6 = []byte{
	...
	0xe2, 0xcc, 0x2f, 0xc9, 0x29, 0x88, 0xcf, 0x4b, 0xad, 0x28, 0x91, 0xe2, 0x06, 0xcb, 0x43, 0xc4,
	...
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xac, 0x22, 0xa2, 0xd0, 0x49, 0x01, 0x00, 0x00,
}
...
func (c *traceServiceClient) Export(ctx context.Context, in *ExportTraceServiceRequest, opts ...grpc.CallOption) (*ExportTraceServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_next.TraceService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TraceService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_next.TraceService/Export",
	}
...
var _TraceService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_next.TraceService",
