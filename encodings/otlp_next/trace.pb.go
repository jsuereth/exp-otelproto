...
type Span struct {
	...
	Kind Span_SpanKind `protobuf:"varint,6,opt,name=kind,proto3,enum=otlp_next.Span_SpanKind" json:"kind,omitempty"`
...
type Status struct {
	...
	DeprecatedCode Status_DeprecatedStatusCode `protobuf:"varint,1,opt,name=deprecated_code,json=deprecatedCode,proto3,enum=otlp_next.Status_DeprecatedStatusCode" json:"deprecated_code,omitempty"` // Deprecated: Do not use.
	// A developer-facing human readable error message.
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	// The status code.
	Code Status_StatusCode `protobuf:"varint,3,opt,name=code,proto3,enum=otlp_next.Status_StatusCode" json:"code,omitempty"`
}
...
func init() {
	proto.RegisterEnum("otlp_next.Span_SpanKind", Span_SpanKind_name, Span_SpanKind_value)
	proto.RegisterEnum("otlp_next.Status_DeprecatedStatusCode", Status_DeprecatedStatusCode_name, Status_DeprecatedStatusCode_value)
	proto.RegisterEnum("otlp_next.Status_StatusCode", Status_StatusCode_name, Status_StatusCode_value)
	proto.RegisterType((*ResourceSpans)(nil), "otlp_next.ResourceSpans")
	proto.RegisterType((*InstrumentationLibrarySpans)(nil), "otlp_next.InstrumentationLibrarySpans")
	proto.RegisterType((*Span)(nil), "otlp_next.Span")
	proto.RegisterType((*Span_Event)(nil), "otlp_next.Span.Event")
	proto.RegisterType((*Span_Link)(nil), "otlp_next.Span.Link")
	proto.RegisterType((*Status)(nil), "otlp_next.Status")
}
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
