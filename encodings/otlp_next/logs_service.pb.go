...
func init() {
	proto.RegisterType((*ExportLogsServiceRequest)(nil), "otlp_next.ExportLogsServiceRequest")
	proto.RegisterType((*ExportLogsServiceResponse)(nil), "otlp_next.ExportLogsServiceResponse")
}
...
var fileDescriptor_7af0811a237bf236 = []byte{
	...
	0xcc, 0x2f, 0xc9, 0x29, 0x88, 0xcf, 0x4b, 0xad, 0x28, 0x91, 0xe2, 0x02, 0x49, 0x43, 0x84, 0x95,
	...
	0x00, 0x00, 0xff, 0xff, 0xf0, 0x78, 0x82, 0xed, 0x3e, 0x01, 0x00, 0x00,
}
...
func (c *logsServiceClient) Export(ctx context.Context, in *ExportLogsServiceRequest, opts ...grpc.CallOption) (*ExportLogsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlp_next.LogsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlp_next.LogsService/Export",
	}
...
var _LogsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "otlp_next.LogsService",
