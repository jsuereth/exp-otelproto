...
type LogRecord struct {
	...
	// [Optional].
	SeverityNumber SeverityNumber `protobuf:"varint,2,opt,name=severity_number,json=severityNumber,proto3,enum=otlp_5.SeverityNumber" json:"severity_number,omitempty"`
...
func init() {
	proto.RegisterEnum("otlp_5.SeverityNumber", SeverityNumber_name, SeverityNumber_value)
	proto.RegisterEnum("otlp_5.LogRecordFlags", LogRecordFlags_name, LogRecordFlags_value)
	proto.RegisterType((*ResourceLogs)(nil), "otlp_5.ResourceLogs")
	proto.RegisterType((*InstrumentationLibraryLogs)(nil), "otlp_5.InstrumentationLibraryLogs")
	proto.RegisterType((*LogRecord)(nil), "otlp_5.LogRecord")
}
...
var fileDescriptor_782e6d65c19305b4 = []byte{
	...
	0x50, 0x74, 0x15, 0x5d, 0x19, 0xae, 0x74, 0x77, 0x57, 0x86, 0x98, 0x08, 0x85, 0x40, 0x34, 0x40,
	...
	0xe5, 0x9f, 0x01, 0x00, 0x00, 0xff, 0xff, 0xb3, 0xa9, 0x0d, 0x76, 0x4f, 0x06, 0x00, 0x00,
}
